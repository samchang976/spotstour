								...
								<form:form method="POST" modelAttribute="memberBean"
									...
									<div class="form-row">
										...
										<div class="form-group">
											...
											<form:input path="mPw" class="form-control"
												placeholder="請輸入6-10個英數字" type="password" />
										</div>
										<div class="form-group">
											<form:label path="mTPw">密碼確認：</form:label>
											<form:errors path="mTPw" class="error" />
											<form:input path="mTPw" class="form-control"
												placeholder="需與密碼一致" type="password" />
									...
									<div class="form-row">
										...
										<div class="form-group">
											...
											<form:input path="mUid" class="form-control"
									...
									<div class="form-group">
										<form:label path="multipartFile">會員照片：</form:label>
										<form:errors path="multipartFile" class="error" />
										<form:input path="multipartFile" class="form-control"
											type="file" />
