  ...
  <body>
        ...
        <div class="container" style="margin: 10px;">
            ...
            <div class="col-9 col-md-3" >
                ...
                <span><button id="news" value="新增活動資訊">新增活動資訊</button></span>
                <span><button id="selectall" value="全選">全選</button></span>
                <span><button id="denine" value="刪除全選">刪除全選</button></span>
            </div>
                    ...
                    <div class="news">
                        ...
                        <div class="block">
                            <div class="left" style="float: left;">
                                <div><input class="form-check-input" type="checkbox" id="checkboxNoLabel" value="" aria-label="..."></div>
                            </div>
                            <!-- 日期 -->
                            <div class="left" style="float: left;">
