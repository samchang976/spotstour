				...
				<div class="shadow p-3 mb-5 bg-body rounded">
					<div id="rule">
						...
						<ul>
							...
							<li>2.	每件商品每個會員帳號限購買3件，超出購買數量或訂購收件資料不正確、無人收件、拒絕收件…等情況，spotsour買東西購物中心有權拒絕接受訂單或取消您的訂單。</li>
							...
							<li>5.	當您訂購多筆商品並選擇以信用卡或信用卡分期付款時，spotsour買東西購物中心將就各筆訂單分別向銀行取得授權，惟可能會因信用卡額度不足、發卡行或收單行限制、本公司授信控管或其他系統因素…等問題，導致發生當次的訂單無法全部取得銀行授權成功之情形。如您仍有需要時，請您另循其他方式訂購。</li>
							<li>6.	spotsour買東西購物中心基於網站營運及與供應商之間合約關係，係以終端消費者為銷售商品對象，您認知並聲明您係以終端消費者之身分進行消費。如您購買商品之目的主要供執行業務或投入生產使用，並非單純供最終消費者使用者，spotsour買東西購物中心有權拒絕提供您一般消費者得享有之權益或優惠（包含但不限於提供購物金與信用卡無息分期或折價券及贈品回饋、抽獎、滿額贈活動、快速到貨延遲申訴、七天猶豫期間…等），並得暫停您原以消費者身分註冊帳號之使用。如您有非終端消費者採購之需求者，請您與客服中心聯絡咨詢大宗採購方案。</li>
							<li>7.	spotsour買東西購物中心基於商業經營策略、風險控管與整體消費者權益之保護，有權拒絕特定消費者之交易，包括但不限於：拒絕接受會員登錄、暫停或終止會員帳號、限制會員消費金額或優惠、回饋之使用。如會員有違反本公司相關條款或濫用本公司服務者，並得收回或取消相關回饋點數，並請求因此所生之損害賠償。</li>
							<li>＊商品配送＊</li>
							...
							<li>6.	本公司配合環保署廢四機回收服務，環保署資源回收專線(0800-000000)，本公司廢四機回收專線(客服專線02-0000-0000，服務時間：週一至週五（不含例假日）09:00 ~ 18:00)</li>
							<li>＊商品退貨＊</li>
