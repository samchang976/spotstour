...
<body>
	...
	<div class='menuOuter'>
		...
		<a id="SPOTTOUR" href="<c:url value='/' />" target="_parent"
			data-bs-toggle="tooltip" data-bs-placement="bottom"
			title="Spots-tour 首頁"> SPOTS-TOUR </a>
		<div id='option2'>
			<!-- 內嵌網站把連結導向父層 -->
			<!-- <div>
			...
			<ul class="nav nav-tabs">
				...
				<li class="nav-item dropdown"><a class="fas fa-cart-plus "
					...
					<ul class="dropdown-menu">
						<li><a class="dropdown-item"
							...
							data-bs-toggle="tooltip" data-bs-placement="bottom"
							title="前往購物商城首頁">購物商城首頁</a></li>
						<li><a class="dropdown-item"
							href="<c:url value="/merchandiseSearchResult"/>"
							data-bs-toggle="tooltip" data-bs-placement="bottom"
							title="前往商城查詢全部商品">查看所有商品</a></li>
						<li><a class="dropdown-item"
							href="<c:url value="/aboutMerchandise"/>"
							data-bs-toggle="tooltip" data-bs-placement="bottom"
							title="查詢關於商品配送資訊">關於商品資訊</a></li>

						<c:if test="${ mPid == 2 || mPid == 1}">
							<li><a class="dropdown-item"
								href="<c:url value="/shoppingCart"/>" data-bs-toggle="tooltip"
								data-bs-placement="bottom" title="會員可以查詢個人已加入購物車內容">我的購物車</a></li>
							<li><a class="dropdown-item"
								href="<c:url value="/myOrderList"/>" data-bs-toggle="tooltip"
								data-bs-placement="bottom" title="會員可以查詢個人訂單及訂單明細">我的訂單</a></li>
						</c:if>
						<c:if test="${ mPid == 1 }">
							<li><hr class="dropdown-divider"></li>
							<li><a class="dropdown-item"
								href="<c:url value="/merchandiseModify"/>"
								data-bs-toggle="tooltip" data-bs-placement="bottom"
								title="管理者可以新增 刪除 修改 查詢所有商城商品">管理商城</a></li>
							<li><a class="dropdown-item"
								href="<c:url value="/activityList"/>" data-bs-toggle="tooltip"
								data-bs-placement="bottom" title="管理者可以新增 刪除 修改 查詢所有商城活動資訊">管理活動列表</a></li>
							<li><a class="dropdown-item"
								href="<c:url value="/activityModify"/>" data-bs-toggle="tooltip"
								data-bs-placement="bottom" title="管理者可以新增商城活動資訊">新增活動快訊</a></li>
							<li><a class="dropdown-item"
								href="<c:url value="/myOrderList"/>" data-bs-toggle="tooltip"
								data-bs-placement="bottom" title="管理者可以查看所有訂單資訊">管理訂單資訊</a></li>
							<li><a class="dropdown-item"
								href="<c:url value="/aboutMerchandiseModify"/>"
								data-bs-toggle="tooltip" data-bs-placement="bottom"
								title="管理者可以編輯關於商品訂購與配送">編輯關於商品</a></li>
							<li><a class="dropdown-item"
								href="<c:url value="/manageFeedback"/>" data-bs-toggle="tooltip"
								data-bs-placement="bottom" title="管理者可以刪除不適當的商品留言">管理所有商品留言</a></li>
							<li><a class="dropdown-item"
				...
				<li class="nav-item dropdown"><a class="fas fa-user-alt "
					...
					<ul class="dropdown-menu">
						<c:if test="${ empty LoginOK }">
							...
							<li><a class="dropdown-item" href="<c:url value="/login"/>"
								data-bs-toggle="tooltip" data-bs-placement="bottom"
				...
				<li class="nav-item dropdown"><a class="fas fa-align-justify "
					data-bs-toggle="dropdown" href="#" role="button"
					aria-expanded="false" data-bs-toggle="tooltip"
					data-bs-placement="bottom" title="其他資訊"></a>
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" href="<c:url value="/aboutUs"/>"
							data-bs-toggle="tooltip" data-bs-placement="bottom"
							title="查看關於Spots-tour">關於我們</a></li>
						<li><a class="dropdown-item"
							href="<c:url value="/contactUs"/>" data-bs-toggle="tooltip"
							data-bs-placement="bottom" title="聯絡Spots-tour">聯絡我們</a></li>
						<c:if test="${ mPid == 1 }">
							<li><a class="dropdown-item"
								href="<c:url value="/aboutUsModify"/>" data-bs-toggle="tooltip"
								data-bs-placement="bottom" title="管理者可以編輯關於Spots-tour">編輯關於我們</a></li>
							<li><a class="dropdown-item"
								href="<c:url value="/contactUsModify"/>"
								data-bs-toggle="tooltip" data-bs-placement="bottom"
								title="管理者可以編輯聯絡Spots-tour的資訊">編輯聯絡我們</a></li>
						</c:if>
					</ul></li>
			</ul>
		</div>
