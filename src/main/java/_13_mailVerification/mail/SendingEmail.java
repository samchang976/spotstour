package _13_mailVerification.mail;
...
public class SendingEmail {
	...
	public SendingEmail(Integer mId, String mEmail, String mName, MemberBean memberBean) {
		super();
		this.mId = mId;
		this.mEmail = mEmail;
		this.mName = mName;
	...
	public void sendMail() {
		...
		try {
			...
			// 設定信件標題
			message.setSubject("SpotsTour新會員電子郵件認證信件");
		
			Timestamp ts = memberBean.getM_createTime();
