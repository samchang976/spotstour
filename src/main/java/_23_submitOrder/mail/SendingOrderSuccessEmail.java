...
//					+ "\n\nVerification Link: " + "http://localhost:8082/TrainMe/ActivateAccount?key=" + type + "&key1=" + userEmail + "&key2=" + myHash);
			String messageStr ="<!doctype html>\r\n"
					...
					+ "                                <a class=\"mcnButton \" title=\"查看課程\" href=\"http://localhost:8082/TrainMe/st_info_lesson?key=" + mId + "\"  target=\"_blank\" style=\"font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;\">查看課程</a>\r\n"
					+ "                            </td>\r\n"
					+ "                        </tr>\r\n"
					+ "                    </tbody>\r\n"
					+ "                </table>\r\n"
