...
(4,'輸入SPOTSTOURJAVA015 優惠八折','新春優惠','2021-02-10',0,NULL,''),
(5,'活動優惠 立即查看','活動優惠，全館免運!','2021-02-20',0,NULL,''),
(6,'請輸入折扣碼 SPOTSTOURJAVA015','好康優惠!!','2021-03-01',0,NULL,''),
(7,'點擊立即查看','活動開跑，全館免運! ','2021-03-15',0,NULL,'');
...
(82,'小家庭，6人份剛剛好~推推','2021-03-24 22:40:58',0,18),
(83,'新機啟用會有點臭臭的味道，建議第一次啟用前要有開鍋程序','2021-03-24 22:43:58',0,18),
(84,'還是喜歡大同電鍋，便宜又好用 反推','2021-03-24 22:44:25',0,18),
(85,'煮飯也可以邊熱菜，是家庭主婦的好幫手~~','2021-03-24 22:45:33',0,18),
(86,'小巧可愛不占空間，定時功能好用~','2021-03-24 22:46:58',0,18),
(87,'每次去日本一定帶，家人朋友都喜歡~','2021-03-24 22:47:51',0,6),
(88,'雖然有點小貴，但很喜歡它的味道~','2021-03-24 22:48:15',0,6),
(89,'是不錯但很甜，吃一兩片還好，吃多就會膩 ','2021-03-24 22:49:28',0,6),
(90,'黑巧克力的好吃!!','2021-03-24 22:50:08',0,6),
(91,'推小7平價版的，現在有買二送一','2021-03-24 22:50:44',0,6),
(92,'太貴了，買不下去 = =','2021-03-24 22:51:33',0,6),
(93,'一口咬下，餅乾體很酥脆，淡淡的奶油香氣。 推~','2021-03-24 22:57:19',0,3),
(94,'裡頭的焦糖帶點黏口，香香甜甜的，奶油餡則是柔滑順口，與酥到不行的餅乾體混搭在一\r\n起口感很好。','2021-03-24 22:57:33',0,3),
(95,'還不錯吃，不過價格不太可愛。','2021-03-24 22:58:00',0,3),
(96,'保存期限很短','2021-03-24 22:58:18',0,3),
(97,'覺得普','2021-03-24 22:58:30',0,3),
(98,'貴但好吃','2021-03-24 22:58:50',0,3),
(99,'比想像中好吃，不過熱量跟價格都只能淺嚐','2021-03-24 22:59:00',0,3),
(100,'麗茲這個甜味的餅乾搭起士真的超怪','2021-03-24 23:00:39',0,15),
(101,'我覺得不好吃..Richeese的BIG ROLLS好吃多了','2021-03-24 23:00:54',0,15),
(102,'麗滋捲心酥的起士有一股甜味 和夾心餅的鹹味不同 感覺被騙了','2021-03-24 23:01:27',0,15),
(103,'太貴CP值不高','2021-03-24 23:01:49',0,15),
(104,'很滿意','2021-03-24 23:03:23',0,4),
(105,'夾心餅乾好吃到升天','2021-03-24 23:06:28',0,23),
(106,'日本必買伴手禮!!','2021-03-24 23:08:23',0,23),
(107,'最喜還起司口味~','2021-03-24 23:08:49',0,23),
(108,'現在台北也買的到了~~~','2021-03-24 23:09:37',0,23);
